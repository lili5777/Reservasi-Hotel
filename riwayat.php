  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-9 pt-4 ps-5 px-5">
        <h3><i class="fa-solid fa-landmark me-3"></i>Riwayat Pembelian</h3><hr>
        <table class="table table-striped table-hover">
            ...
            <?php foreach ($history as $key): ?>
                ...
                <?php foreach ($kamar as $kamar_id) {
                  if($kamar_id['id'] == $key['id_kamar']){
                    echo $kamar_id['status_bayar'];
                    break;
                  
                } }?>
                  
                </td>
                <td><a href="function.php?id_r=<?php echo $key['id_pesanan'] ?>&id_kamar=<?php echo $key['id_kamar'] ?>">CHECK OUT</a></td>
              </tr>
